...
- `[holoscan_parameter("param_name")]`: Marks a scalar uniform as a configurable parameter
...
```cpp
#include <holoscan/operators/slang_shader/slang_shader_op.hpp>

// Create the operator
auto shader_op = fragment->make_operator<holoscan::ops::SlangShaderOp>(
    "shader_source", shader_source_string,
    "name", "my_shader"
);
```
